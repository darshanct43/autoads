...
const mobileLayoutRegex = /\{\/\* Mobile Card Layout \*\/\}[\s\S]*?(?=\s*\)\s*:\s*activeTab === "USERS")/m;
                      ...
                      >
                        <summary className="p-5 cursor-pointer list-none flex justify-between items-center outline-none">
                          ...
                          <div className="flex items-center gap-3">
                             <div className={\`w-2 h-2 rounded-full \${d.status === "active" ? "bg-green-500" : "bg-amber-500"}\`} />
                        ...
                        <div className="px-5 pb-5 pt-2 border-t border-slate-100/50 space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-50 flex flex-col items-center">
                              ...
                              <p className="text-[10px] font-black uppercase flex gap-1 items-center">
                                {d.status}
                              </p>
                            </div>
                          </div>
                          <div className="flex flex-col gap-2 pt-2">
                            <button
                              ...
                              className="w-full py-3 bg-amber-500 text-slate-950 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-sm"
                            >
                              Make Payment
                            </button>
                            {d.status !== "active" && !d.accessKey && (
                              <button
                                ...
                                className="w-full py-3 bg-slate-900 text-amber-500 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-sm"
                              >
                                Provision Device
                              </button>
                            )}
